...
# This program will change 3 bits per R G B or a, which means hide 8bit per pixel.
# @Author: Kai Ding
        ...
        for col in row:
            for element in range(len(col)):
                if index < len(hide_text):
                    ...
                    bi_rgb = bi_rgb[:-2] + hide_text[index] + hide_text[index + 1] + hide_text[index + 2]
